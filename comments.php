...
<div id="comments" class="comments-area">
    ...
    <?php if(comments_open()) : ?>
        <div id="respond" class="respond" role="form">
            ...
            <?php else : ?>
                <form class="uk-form-horizontal uk-margin-large" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
                    <?php if ( $user_ID ) : ?>
                    ...
                    <?php else : ?>
                        <div class="uk-margin">
                            <label class="uk-form-label" for="author">作者*</label>
                            <div class="uk-form-controls">
                                <input class="uk-input" id="author" name="author" type="text" aria-required="true" placeholder="作者" value="<?php echo $comment_author; ?>" >
                            </div>
                        </div>
                        <div class="uk-margin">
                            <label class="uk-form-label" for="email">作者邮箱*</label>
                            <div class="uk-form-controls">
                                <input class="uk-input" id="email" name="email" type="text" aria-required="true" placeholder="邮箱" value="<?php echo $comment_author_email; ?>" >
                            </div>
                        </div>
                        <div class="uk-margin">
                            <label class="uk-form-label" for="url">主页*</label>
                            <div class="uk-form-controls">
                                <input class="uk-input" id="url" name="url" type="text" aria-required="true" placeholder="主页" value="<?php echo $comment_author_url; ?>" >
                            </div>
                        </div>
